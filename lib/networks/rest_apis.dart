...
Future<ConfigurationResponse> configurationDashboard() async {
  ...
  data.configurations.validate().forEach((data) {
    ...
    } else if (data.key == ONESIGNAL_APP_ID_USER) {
      if (data.value.validate().isNotEmpty) {
        setValue(ONESIGNAL_APP_ID_USER, data.value);
      }
    } else if (data.key == ONESIGNAL_REST_API_KEY_USER) {
      if (data.value.validate().isNotEmpty) {
        setValue(ONESIGNAL_REST_API_KEY_USER, data.value);
      }
    } else if (data.key == ONESIGNAL_CHANNEL_KEY_USER) {
      if (data.value.validate().isNotEmpty) {
        setValue(ONESIGNAL_CHANNEL_KEY_USER, data.value);
      }
    }
  });
